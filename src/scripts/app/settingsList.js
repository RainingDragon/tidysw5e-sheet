export function settingsList() {
  // General Settings
		...
		game.settings.register("tidysw5e-sheet", "hpOverlayBorderNpc", {
			...
			type: Number,
			onChange: data => {
				$('.system-sw5e').get(0).style.setProperty('--npc-border', game.settings.get("tidysw5e-sheet", "hpOverlayBorderNpc")+'px');
			}
		});
		...
		game.settings.register("tidysw5e-sheet", "hpOverlayBorderVehicle", {
			...
			type: Number,
			onChange: data => {
				$('.system-sw5e').get(0).style.setProperty('--vehicle-border', game.settings.get("tidysw5e-sheet", "hpOverlayBorderVehicle")+'px');
			}
		});
		...
		// Hidden Death Saves
		game.settings.register("tidysw5e-sheet", "hiddenDeathSavesEnabled", {
		...
		game.settings.register("tidysw5e-sheet", "defaultActionsTab", {
		...
		game.settings.register("tidysw5e-sheet", "playerSheetWidth", {
		...
		game.settings.register("tidysw5e-sheet", "npsSheetWidth", {
		...
		game.settings.register("tidysw5e-sheet", "vehicleSheetWidth", {
